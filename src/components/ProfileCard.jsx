...
const DEFAULT_INNER_GRADIENT =
  'linear-gradient(145deg, rgba(216, 199, 255, 0.34) 0%, rgba(38, 29, 64, 0.72) 44%, rgba(6, 7, 11, 0.98) 100%)';
...
function ProfileCardComponent({
  ...
  behindGlowColor = 'rgba(216, 199, 255, 0.72)',
  behindGlowSize = '50%',
  className = '',
  enableTilt = true,
  ...
  miniAvatarUrl,
  name = 'LinM',
  title = 'Visual / AI / Brand Designer',
  handle = 'LinMMinL',
  status = 'Fuzhou based designer',
  contactText = 'Contact',
  onContactClick,
}) {
  ...
  const handlePointerLeave = useCallback(() => {
    ...
    if (leaveRafRef.current) window.cancelAnimationFrame(leaveRafRef.current);
    leaveRafRef.current = window.requestAnimationFrame(checkSettle);
  }, [tiltEngine]);
          ...
          <div className="pc-inside">
            ...
            <div className="pc-content pc-avatar-content">
              ...
              <div className="pc-user-info">
                ...
                <button className="pc-contact-btn" type="button" onClick={handleContactClick}>
                  {contactText}
                </button>
              </div>
            </div>
